...
const TITLE = "Webdesign für Dienstleister – Website für lokale Dienstleistungen | Impova";
const DESCRIPTION =
...
export const metadata: Metadata = {
  ...
  ...pageOpenGraph({ title: TITLE, description: DESCRIPTION, path: "/branchen/dienstleister" }),
};
