    ...
    <>
      ...
      <main>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
              <Reveal className="lg:col-span-7">
                ...
                <p className="mt-6 max-w-lg text-lg leading-relaxed text-zinc-400">
                  Keine Agentur mit mehreren Abteilungen dazwischen. Vom
                  ersten Gespräch bis zum Launch deiner Website sprichst du
                  direkt mit mir.
                </p>
              </Reveal>
        ...
        <section className="border-b border-zinc-900 py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <Reveal>
              <Eyebrow index="02">Werdegang</Eyebrow>
              <h2 className="mt-5 max-w-2xl text-3xl font-medium leading-tight tracking-tight text-zinc-50 sm:text-4xl">
                Wie ich zu Impova gekommen bin
              </h2>
              <div className="mt-6 flex max-w-2xl flex-col gap-4 text-zinc-400">
                <p>
                  Seit November 2025 baue ich Websites für Unternehmen in
                  Landshut und Umgebung. Die Grundlagen im Online-Marketing
                  habe ich mir über eine Weiterbildung bei HeyFreiheit
                  angeeignet — von dort kommt mein Blick auf SEO, Conversion
                  und Nutzerführung, nicht nur auf Design.
                </p>
                <p>
                  Umgesetzt wird jedes Projekt so, wie es für dich am
                  meisten Sinn ergibt: WordPress mit Oxygen Builder, wenn du
                  schnell live gehen und Inhalte später selbst pflegen
                  willst, oder handgeschriebener Next.js-Code, wenn Design
                  und Ladezeit ganz vorne mitspielen sollen. Wie das konkret
                  aussieht, siehst du an den{" "}
                  <Link
                    href="/#referenzen"
        ...
        <section className="border-b border-zinc-900 py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <Reveal>
              <Eyebrow index="03">Zusammenarbeit</Eyebrow>
              <h2 className="mt-5 max-w-2xl text-3xl font-medium leading-tight tracking-tight text-zinc-50 sm:text-4xl">
